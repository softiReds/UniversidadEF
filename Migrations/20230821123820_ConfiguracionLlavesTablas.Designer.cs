...
namespace UniversidadEF.Migrations
{
    ...
    [Migration("20230821123820_ConfiguracionLlavesTablas")]
    partial class ConfiguracionLlavesTablas
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UniversidadEf.Models.Alumno", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PersonaId = new Guid("ec4edb8d-4f84-4aea-aebc-a60f98810c43")
                        });
                });
            ...
            modelBuilder.Entity("UniversidadEf.Models.Persona", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            PersonaId = new Guid("9505c0e7-2707-4f5e-a760-2cad68c82cd4"),
                        ...
                        new
                        {
                            PersonaId = new Guid("4b75643d-6fdc-49a8-97b6-897e9452c0fc"),
            ...
            modelBuilder.Entity("UniversidadEf.Models.Alumno", b =>
                {
                    b.HasOne("UniversidadEf.Models.Persona", "Persona")
                        .WithOne("Alumno")
                        .HasForeignKey("UniversidadEf.Models.Alumno", "PersonaId")
            ...
            modelBuilder.Entity("UniversidadEf.Models.Profesor", b =>
                {
                    b.HasOne("UniversidadEf.Models.Persona", "Persona")
                        .WithOne("Profesor")
                        .HasForeignKey("UniversidadEf.Models.Profesor", "PersonaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UniversidadEf.Models.Rector", b =>
                {
                    b.HasOne("UniversidadEf.Models.Persona", "Persona")
                        .WithOne("Rector")
                        .HasForeignKey("UniversidadEf.Models.Rector", "PersonaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
